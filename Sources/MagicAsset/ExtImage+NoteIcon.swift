...
public extension Image {
    static func makeNoteIcon(useDefaultBackground: Bool = true, borderColor: Color = .blue) -> some View {
        NoteIcon(useDefaultBackground: useDefaultBackground, borderColor: borderColor)
    }
}
...
#Preview {
    MagicThemePreview {
        VStack(spacing: 20) {
            Image.makeNoteIcon(useDefaultBackground: true)
                .frame(width: 500, height: 500)
            
            Image.makeNoteIcon(useDefaultBackground: false, borderColor: .red)
                .frame(width: 500, height: 500)
