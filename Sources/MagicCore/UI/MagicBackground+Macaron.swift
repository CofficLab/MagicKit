...
extension MagicBackground {
    static public var vanillaMacaron: some View {
        ZStack {
            // 香草奶油色
            LinearGradient(
    ...
    static public var roseMacaron: some View {
        ZStack {
            // 玫瑰粉色
            LinearGradient(
                gradient: Gradient(colors: [
    ...
    static public var lavenderMacaron: some View {
        ZStack {
            // 薰衣草紫色
            LinearGradient(
                gradient: Gradient(colors: [
    ...
    static public var mintMacaron: some View {
        ZStack {
            // 薄荷绿色
            LinearGradient(
                gradient: Gradient(colors: [
    ...
    static public var lemonMacaron: some View {
        ZStack {
            // 柠檬黄色
            LinearGradient(
                gradient: Gradient(colors: [
