...
extension MagicBackground {
    static public var cosmicDust: some View {
        ZStack {
    ...
    static public var galaxySpiral: some View {
        ZStack {
            // 深空背景
    ...
    static public var nebulaMist: some View {
        ZStack {
            // 基础背景
    ...
    static public var darkMatter: some View {
        ZStack {
            // 深空背景
    ...
    static public var cosmicPortal: some View {
        ZStack {
            // 深空背景
