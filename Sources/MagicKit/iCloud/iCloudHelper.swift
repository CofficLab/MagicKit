...
public class iCloudHelper: SuperLog, SuperThread {
    public static var emoji = "☁️"

    public static func iCloudDiskEnabled() -> Bool {
        return FileManager.default.ubiquityIdentityToken != nil
    }

    // MARK: 下载状态

    public static func getStatus(_ url: URL) -> String {
        getDownloadingStatus(url: url).rawValue
    }

    public static func getDownloadingStatus(url: URL) -> URLUbiquitousItemDownloadingStatus {
    ...
    public static func isDownloaded(_ u: URL) -> Bool {
        let verbose = false
        var url = u
    ...
    public static func isNotDownloaded(_ url: URL) -> Bool {
        !isDownloaded(url)
    }
    ...
    public static func isNotExists(_ url: URL) -> Bool {
        !fileExists(url: url)
    }

    public static func isCloudPath(url: URL) -> Bool {
    ...
    public static func watchDownloading(_ url: URL) {
        // 创建一个后台队列
...
extension iCloudHelper {
    ...
    public static func checkiCloudStorage1() {
        // 获取当前iCloud容量
    ...
    public static func checkiCloudStorage2() {
        let fileManager = FileManager.default
    ...
    public static func getAvailableStorage() throws -> Int64 {
        // 获取当前iCloud容量
        let fileManager = FileManager.default
    ...
    public static func getTotalStorage() throws -> Int {
        // 获取当前iCloud容量
        let fileManager = FileManager.default
    ...
    public static func getTotalStorageReadable() -> String {
        do {
    ...
    public static func getAvailableStorageReadable() -> String {
        do {
    ...
    /// 执行并输出耗时
    public static func printRunTime(_ title: String, tolerance: Double = 1, verbose: Bool = false, _ code: () -> Void) {
        if verbose {
            os_log("\(self.t)\(title)")
        }
